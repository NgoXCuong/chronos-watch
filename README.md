...
# Tạo app
heroku create chronos-watch-api
...
# Start with PM2
pm2 start src/server.js --name "chronos-api"
pm2 save
```
...
# Deploy thư mục dist qua Netlify
# Hoặc kết nối GitHub repo trực tiếp
```
...
# Copy dist folder tới web server
sudo cp -r dist/* /var/www/chronos-watch/

# Cấu hình Nginx
sudo nano /etc/nginx/sites-available/chronos-watch
```
...
- Tối đa 100 request/phút cho public API
- Tối đa 500 request/phút cho authenticated users
...
![GitHub stars](https://img.shields.io/github/stars/yourusername/chronos-watch?style=social)
![GitHub forks](https://img.shields.io/github/forks/yourusername/chronos-watch?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/yourusername/chronos-watch?style=social)
