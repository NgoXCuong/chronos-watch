    ...
    return (
        <div className={`min-h-screen flex items-center justify-center pt-20 ${isDark ? 'bg-[#080808]' : 'bg-white'}`}>
            <div className="max-w-[500px] w-full px-6 text-center">
                ...
                <h1 className={`text-3xl font-black uppercase  mb-4 ${isDark ? 'text-white' : 'text-zinc-900'}`}>
                    Thanh toán thất bại
                </h1>

                <p className={`text-md leading-relaxed mb-10 ${isDark ? 'text-zinc-600' : 'text-zinc-700'}`}>
                ...
                <div className={`p-6 rounded-2xl border mb-10 text-left space-y-4 ${isDark ? 'bg-zinc-900/40 border-white/5' : 'bg-zinc-50 border-zinc-100'}`}>
                    <p className={`text-[11px] uppercase font-bold  ${isDark ? 'text-zinc-700' : 'text-zinc-600'}`}>Các lý do có thể xảy ra:</p>
                    <ul className={`text-xs space-y-2 list-disc pl-4 ${isDark ? 'text-zinc-600' : 'text-zinc-600'}`}>
                ...
                <div className="flex flex-col gap-4">
                    <Button
                        ...
                        variant="primary"
                        className="h-14 rounded-xl font-bold uppercase  text-[10px]"
                    >
                    ...
                    <div className="flex gap-4">
                        <Button
                            ...
                            variant="outline"
                            className={`flex-1 h-12 rounded-xl text-[10px] uppercase font-bold  ${isDark ? 'border-white/5 text-zinc-600' : 'border-zinc-200 text-zinc-700'}`}
                        >
