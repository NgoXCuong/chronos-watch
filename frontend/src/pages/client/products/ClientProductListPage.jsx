                        ...
                        <div className="sticky top-32 space-y-6">
                            ...
                            <div className={`pb-4 border-b ${isDark ? 'border-white/5' : 'border-zinc-100'}`}>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className={`text-[11px] uppercase font-bold ${isDark ? 'text-zinc-400' : 'text-zinc-700'}`}>Danh Mục</h3>
                                </div>
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-2 text-center text-xs transition-all duration-300 rounded-md border truncate
                                            ${!currentCategory
                                                ...
                                                : (isDark ? 'border-white/5 text-zinc-400 hover:border-white/20 hover:text-white' : 'border-zinc-100 text-zinc-700 hover:border-zinc-200 hover:text-zinc-900')
                                            }`}
                                    >
                                        Tất cả
                                    </button>
                            ...
                            <div className={`pb-4 border-b ${isDark ? 'border-white/5' : 'border-zinc-100'}`}>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className={`text-[11px] uppercase font-bold ${isDark ? 'text-zinc-400' : 'text-zinc-700'}`}>Thương Hiệu</h3>
                                </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className={`text-[11px] uppercase font-bold ${isDark ? 'text-zinc-400' : 'text-zinc-700'}`}>Khoảng Giá</h3>
                                </div>
                    ...
                    <main className="flex-1">
                        ...
                        <div className={`flex items-center justify-between mb-10 pb-6 border-b ${isDark ? 'border-white/5' : 'border-zinc-100'}`}>
                            ...
                            <div className="flex items-center gap-6">
                                <span className={`hidden md:inline text-[10px] uppercase font-bold  ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>Sắp xếp theo</span>
                                <select
                                    value={currentSort}
                        ...
                        {(currentCategory || currentBrand || currentMinPrice || currentMaxPrice || currentSearch) && (
                            <div className="flex flex-wrap gap-2 mb-8">
                                ...
                                <button onClick={clearFilters} className={`text-[10px] uppercase font-bold underline transition-colors ${isDark ? 'text-zinc-400 hover:text-white' : 'text-zinc-600 hover:text-zinc-900'}`}>Xóa tất cả</button>
                            </div>
                        )}
                        ...
                        {loading ? (
                            ...
                            <div className="py-32 text-center">
                                ...
                                <p className={`text-sm ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>Hãy thử đổi bộ lọc hoặc từ khóa tìm kiếm khác.</p>
