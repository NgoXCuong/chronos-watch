    ...
    <div className="py-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          {/* ── Top meta bar ── */}
          <div
            className={`relative z-10 flex items-center justify-between px-8 md:px-14 pt-10 pb-6 border-b ${
              isDark ? "border-white/5" : "border-zinc-200/60"
            }`}
          >
            <div className="flex items-center gap-3">
              ...
              <span
                className={`text-[12px] uppercase font-bold ${isDark ? "text-zinc-500" : "text-zinc-400"}`}
              >
                Biên tập viên · {product.brand?.name || "Chronos"}
              </span>
            </div>
            <span
              className={`text-[12px] uppercase font-bold ${isDark ? "text-zinc-600" : "text-zinc-350"}`}
            >
              Fine Timepieces
            </span>
          </div>
          ...
          {/* ── Bottom colophon bar ── */}
          <div
            className={`relative z-10 flex items-center justify-between px-8 md:px-14 py-6 border-t ${
              isDark ? "border-white/5" : "border-zinc-200/60"
            }`}
          >
