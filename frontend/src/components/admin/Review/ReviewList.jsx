...
const ReviewList = ({ reviews, loading, onToggleStatus, onReply }) => {
  if (loading) {
    return (
  ...
  if (!reviews.length) {
    return (
      <div className="py-20 text-center bg-white rounded-3xl border border-slate-100 shadow-sm">
        ...
        <p className="text-slate-400 font-roboto uppercase text-[10px] font-black">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6">
                ...
                {review.admin_reply && (
                  <div className="mt-2.5 flex items-start gap-2 bg-amber-50/20 p-2 rounded-lg border border-amber-100/30">
                    ...
                    <p className="text-[11px] font-bold text-slate-700 line-clamp-1 italic">
                      <span className="text-amber-600 mr-1.5 font-black uppercase text-[10px]">
                        Admin:
                      </span>
                      {review.admin_reply}
                    </p>
              ...
              <div className="shrink-0 flex items-center gap-2.5 pl-4 border-l border-slate-100 w-full lg:w-auto">
                <Button
                  ...
                  className={`flex-1 lg:w-28 h-9 rounded-xl gap-2 text-[10px] font-black uppercase transition-all duration-300 hover:scale-105 active:scale-95 ${
                    review.admin_reply
                ...
                <Button
                  ...
                  className={`flex-2 lg:w-24 h-9 rounded-xl gap-2 text-[10px] font-black uppercase transition-all duration-300 hover:scale-105 active:scale-95 border-slate-200 ${
                    review.is_active
