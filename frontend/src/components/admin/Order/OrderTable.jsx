      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead className="bg-slate-50 border-b border-slate-100">
            <tr>
              <th className="px-6 py-5 text-[11px] font-semibold text-slate-500 uppercase ">
                Mã đơn
              </th>
              <th className="px-6 py-5 text-[11px] font-semibold text-slate-500 uppercase ">
                Khách hàng
              ...
              <th className="px-6 py-5 text-[11px] font-semibold text-slate-500 uppercase text-right">
                Thao tác
              </th>
            </tr>
          </thead>
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger
                      className={cn(
                        ...
                        "h-10 w-10 rounded-xl text-slate-400 hover:text-slate-900 hover:bg-white shadow-sm border border-transparent hover:border-slate-100 transition-all focus:outline-none focus:ring-0",
                      )}
                    >
                    ...
                    >
                      <DropdownMenuItem
                        ...
                        onClick={() => onView(order.id)}
                      >
                        <Eye className="h-4 w-4 text-slate-400" /> Chi tiết đơn
                        hàng
                      </DropdownMenuItem>
