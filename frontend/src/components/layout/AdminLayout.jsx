                ...
                <div className="flex flex-col h-full">
                                ...
                                <div className="space-y-0.5">
                                    {section.items.map((item) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <item.icon className={cn("h-4 w-4 flex-shrink-0", isActive ? "text-amber-600" : "text-slate-400 group-hover:text-slate-600")} />
                    ...
                    <div className="p-3 border-t border-slate-100 bg-white">
                        ...
                        >
                            ...
                            <span className={cn(!isSidebarOpen && "lg:hidden font-medium")}>Xem Website</span>
                        </Link>
                        <button
